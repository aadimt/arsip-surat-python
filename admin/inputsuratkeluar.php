...
<html lang="en">
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="proses/proses_inputsuratkeluar.php"  name="formsuratkeluar" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Kategori Surat <span class="required">*</span>
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select id="kode_suratkeluar" name="kode_suratkeluar" required="required" class="form-control col-md-7 col-xs-12">
                            <option value="">-- Pilih Kategori Surat --</option>
                            <option value="SE">[1] Surat Edaran</option>
                            <option value="SK">[2] Surat Keputusan</option>
                            <option value="SP">[3] Surat Permohonan</option>
                            <option value="ST">[4] Surat Tugas</option>
                            <option value="SU">[5] Surat Undangan</option>
                          </select>
                          <small class="form-text text-muted">Sistem Naive Bayes akan otomatis suggest kategori berdasarkan perihal</small>
                        </div>
                      </div>
    ...
    <script src="js/naive_bayes_integration.js"></script>
...
<script>
    ...
    // Predict kode_surat based on year when tanggal surat is set
    $('#single_cal3').on('change', function(){
      var dateVal = $(this).val();
      $.post('api/predict_category.php', { type: 'keluar', date: dateVal }, function(resp){
        if (resp && resp.predicted) {
          $('#kode_suratkeluar').val(resp.predicted);
        }
      }, 'json');
    });
