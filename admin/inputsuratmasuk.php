                  ...
                  <div class="x_content">
                    ...
                    <form action="proses/proses_inputsuratmasuk.php"  name="formsuratmasuk" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select id="kode_suratmasuk" name="kode_suratmasuk" required="required" class="form-control col-md-7 col-xs-12">
...
<script>
    ...
    $('#single_cal3').on('change', function(){
      ...
      $.post('api/predict_category.php', { type: 'masuk', date: dateVal }, function(resp){
        if (resp && resp.predicted) {
          $('#kode_suratmasuk').val(resp.predicted);
        }
      }, 'json');
    });
